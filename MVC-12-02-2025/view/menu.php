            ...
            <div class="header-navigation" role="navigation">
                <ul class="main-header-menu">
                    ...
                    <li class="main-header-menu-item">
                        <a class="main-header-menu-link" href="/entrenadores">
                            <span class="value">Entrenadores</span>
                        </a>
                    </li>
                    <li class="main-header-menu-item">
                        <a class="main-header-menu-link" href="/comunidad">
                            <span class="value">Comunidad</span>
                        </a>
                    </li>
                    <li class="main-header-menu-item">
                        <a class="main-header-menu-link" href="/quienessomos">
                            <span class="value">Quienes somos</span>
                        </a>
                    </li>
                </ul>
