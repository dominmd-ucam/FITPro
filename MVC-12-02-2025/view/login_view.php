...
<form action="" method="post">
    ...
    <button type="submit" name="submit" class="btn btn-primary w-100 fw-bold fs-5" style="border-radius: 0;">
        Entrar
    </button>

    <div class="text-center mt-3">
    <span class="text-dark fw-bold">¿No tienes cuenta?</span>
    <a href="index.php?controlador=miembros&action=registrar" class="fw-bold text-primary text-decoration-none">
        Regístrate aquí
    </a>
</div>
