            ...
            <div class="px-4 py-3">
              <div class="flex w-full flex-1 items-stretch rounded-xl h-12">
                ...
                <div class="dataTables_filter flex-1">
                  <input type="search" class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-white focus:outline-0 focus:ring-0 border-none bg-[#243547] focus:border-none h-full placeholder:text-[#93adc8] px-4 rounded-l-none border-l-0 pl-2 text-base font-normal leading-normal" placeholder="Search trainers by name, email, phone number">
                </div>
              </div>
            </div>
