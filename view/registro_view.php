...
<head>
  ...
  <title>FitPro - Registro</title>
  <script src="https://cdn.tailwindcss.com?plugins=forms"></script>
  <link href="https://fonts.googleapis.com/css2?family=Lexend:wght@400;600;700&display=swap" rel="stylesheet">
  <style>
    body {
      font-family: 'Lexend', sans-serif;
      background-image: url('assets/imagenes/registro.jpg');
...
<body class="min-h-screen flex flex-col items-center justify-center bg-[#f8fafc]/90 backdrop-blur-sm px-4 py-10">
  ...
  <div class="w-full max-w-md bg-white rounded-2xl shadow-lg p-8 space-y-6">
    ...
    <form action="" method="post" class="space-y-5">
      ...
      <button type="submit" name="registro_submit"
      ...
      <p class="text-center text-sm text-gray-600 mt-2">
        ¿Ya tienes cuenta?
        <a href="index.php?controlador=miembros&action=login" class="text-[#0C77F2] font-semibold hover:underline">
          Inicia sesión aquí
        </a>
      </p>
    </form>
