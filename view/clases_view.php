        ...
        <div class="gap-1 px-6 flex flex-1 justify-center py-5">
              ...
              <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-col gap-1">
                  ...
                  <div class="flex items-center gap-3 px-3 py-2">
                    ...
                    <a class="text-white text-sm font-medium leading-normal" href="index.php?controlador=clases&action=desconectar">Cerrar Sesion</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="layout-content-container flex flex-col max-w-[1200px] flex-1 ml-[320px]">
            <div class="flex flex-wrap justify-between gap-3 p-4">
              <p class="text-white tracking-light text-[32px] font-bold leading-tight min-w-72">Classes</p>
              <button
            ...
            <div class="px-4 py-3">
              <div class="flex w-full flex-1 items-stretch rounded-xl h-12">
                ...
                <div class="dataTables_filter flex-1">
                  <input type="search" class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-white focus:outline-0 focus:ring-0 border-none bg-[#243547] focus:border-none h-full placeholder:text-[#93adc8] px-4 rounded-l-none border-l-0 pl-2 text-base font-normal leading-normal" placeholder="Search classes by name, description or trainer">
                </div>
              </div>
            </div>
                ...
                <table id="classesTable" class="flex-1">
                  <thead>
                    <tr class="bg-[#1a2632]">
                      ...
                      <th class="table-53b9ae36-f9b1-418a-aa1b-d77389b436cd-column-240 px-4 py-3 text-left text-white w-[400px] text-sm font-medium leading-normal">Description</th>
                      ...
                      <th class="table-53b9ae36-f9b1-418a-aa1b-d77389b436cd-column-480 px-4 py-3 text-left text-white w-60 text-sm font-medium leading-normal">Schedule</th>
