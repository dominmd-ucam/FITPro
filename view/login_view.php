...
<html>
  <head>
    ...
    <title>FitMax - Iniciar Sesión</title>
        ...
        <div class="max-w-md mx-auto">
          ...
          <form action="" method="post" class="space-y-6">
            ...
            <div class="text-center mt-4">
              <span class="text-[#0d141c] font-bold">¿No tienes cuenta?</span>
              <a href="index.php?controlador=miembros&action=registrar" class="login-link ml-2">
                Regístrate aquí
              </a>
            </div>
          </form>
