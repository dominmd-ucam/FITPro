...
try {
    error_log("Iniciando script inscribirse_clase.php");
    ...
    error_log("Error en inscribirse_clase.php: " . $e->getMessage());
    error_log("Stack trace: " . $e->getTraceAsString());
    echo json_encode(['success' => false, 'message' => 'Error al realizar la inscripción: ' . $e->getMessage()], JSON_UNESCAPED_UNICODE);
}
?> 