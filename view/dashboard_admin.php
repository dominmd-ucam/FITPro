          ...
          <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
            ...
            <div class="flex flex-wrap gap-4 p-4">
              <div class="flex min-w-[158px] flex-1 flex-col gap-2 rounded-xl p-6 bg-[#293038]">
                <p class="text-white text-base font-medium leading-normal">Total members</p>
              ...
              <div class="flex min-w-[158px] flex-1 flex-col gap-2 rounded-xl p-6 bg-[#293038]">
                <p class="text-white text-base font-medium leading-normal">Active members</p>
                <p class="text-white tracking-light text-2xl font-bold leading-tight">500</p>
                <p class="text-[#0bda5b] text-base font-medium leading-normal">+1%</p>
              </div>
              <div class="flex min-w-[158px] flex-1 flex-col gap-2 rounded-xl p-6 bg-[#293038]">
                <p class="text-white text-base font-medium leading-normal">Inactive members</p>
                <p class="text-white tracking-light text-2xl font-bold leading-tight">200</p>
                <p class="text-[#fa6238] text-base font-medium leading-normal">-1%</p>
              </div>
              <div class="flex min-w-[158px] flex-1 flex-col gap-2 rounded-xl p-6 bg-[#293038]">
                <p class="text-white text-base font-medium leading-normal">Total revenue</p>
                <p class="text-white tracking-light text-2xl font-bold leading-tight">$10,000</p>
                <p class="text-[#0bda5b] text-base font-medium leading-normal">+3%</p>
              </div>
            </div>
            <h2 class="text-white text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Upcoming classes</h2>
            <div class="flex items-center gap-4 bg-[#111418] px-4 min-h-[72px] py-2 justify-between">
              <div class="flex flex-col justify-center">
                <p class="text-white text-base font-medium leading-normal line-clamp-1">HIIT with John Doe</p>
                <p class="text-[#9daab8] text-sm font-normal leading-normal line-clamp-2">12 slots</p>
              </div>
              <div class="shrink-0">
                <button
                  class="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-8 px-4 bg-[#293038] text-white text-sm font-medium leading-normal w-fit"
                >
            ...
            <div class="flex items-center gap-4 bg-[#111418] px-4 min-h-[72px] py-2 justify-between">
              <div class="flex flex-col justify-center">
                <p class="text-white text-base font-medium leading-normal line-clamp-1">Yoga with Jane Doe</p>
                <p class="text-[#9daab8] text-sm font-normal leading-normal line-clamp-2">12 slots</p>
              </div>
              <div class="shrink-0">
                <button
            ...
            <div class="flex items-center gap-4 bg-[#111418] px-4 min-h-[72px] py-2 justify-between">
              <div class="flex flex-col justify-center">
                <p class="text-white text-base font-medium leading-normal line-clamp-1">Pilates with Joe Doe</p>
                <p class="text-[#9daab8] text-sm font-normal leading-normal line-clamp-2">12 slots</p>
              </div>
              <div class="shrink-0">
                <button
